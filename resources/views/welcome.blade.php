...
<html>
    <head>
        ...
        <link rel="stylesheet" href="template1/css/bootstrap-theme.min.css">
        <link rel="stylesheet" href="template1/css/fontAwesome.css">
        <link rel="stylesheet" href="template1/css/hero-slider.css">
        <link rel="stylesheet" href="template1/css/owl-carousel.css">
        <link rel="stylesheet" href="template1/css/datepicker.css">
...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                <li class='active'><a href="#">program Studi</a></li>

                                <li><a class="scrollTo" data-scrollTo="blog" href="#">Arsip</a></li>
                                <li><a class="scrollTo" data-scrollTo="services" href="#">LPMI</a></li>
                                <li><a class="scrollTo" data-scrollTo="contact" href="#">PUSAT STUDI</a></li>
                                    ...
                                    @if (Route::has('login'))
                                        ...
                                        @else
                                        <li><a class="scrollTo" data-scrollTo="login" href="{{ route('login') }}">login</a></li>

                                            @if (Route::has('register'))
                                        <li><a class="scrollTo" data-scrollTo="register" href="{{ route('register') }}">register</a></li>
    ...
    <script>window.jQuery || document.write('<script src="template1/js/vendor/jquery-1.11.2.min.js"><\/script>')</script>
